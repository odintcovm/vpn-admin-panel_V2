...
bash -n deploy.sh scripts/*.sh install.sh
...
echo "[check] docs mention modes and operator checks"
find_text 'docker-compose.*v1\.29\.2|docker compose.*v2' README.md
find_text 'health-check|verify-release-readiness|doctor' README.md
